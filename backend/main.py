...
from .app.routers import download_router, playback_router #, websocket_router # Temporarily commented out
...
def create_app():
    ...
    # app_instance.include_router(websocket_router.router, prefix="/api/ws", tags=["websocket"]) # Temporarily commented out
