...
The application will expect database connection details via environment variables. Create a `.env` file in the `backend` directory with the following (adjust values as per your setup):
