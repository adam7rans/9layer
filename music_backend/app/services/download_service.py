...
from app import models, schemas # Corrected import
from app.config import MUSIC_DOWNLOAD_DIR, AUDIO_FORMAT, AUDIO_POSTPROCESSOR_OPTS, OUTPUT_TEMPLATE
from app.models import AlbumType # Import AlbumType enum
...
def store_track_metadata(db: Session, track_info: dict, file_path: str): # Ensure schemas is not accidentally added here
...
def download_youtube_url(url: str, db: Session, schemas): # Added schemas parameter
